...
<table>
    <tr>
        <td>Info Hash</td>
        <td>ABCDEF1234567890ABCDEF1234567890ABCDEF12</td>
    </tr>
    <tr>
        <td>Tracker 1</td>
...
class TestExtractMagnetLink:
    ...
    def test_extract_magnet_link_success(self, mock_html_get):
        ...
        assert "ABCDEF1234567890ABCDEF1234567890ABCDEF12" in magnet_link
    ...
    def test_extract_magnet_link_cleans_info_hash(self, mock_html_get):
        ...
        <table>
            <tr>
                <td>Info Hash</td>
                <td>ABCDEF1234 567890ABCD EF12345678 90ABCDEF12</td>
            </tr>
        </table>
        </body>
        </html>
